...
test('define',function(){expect(0);
    define('{pro}util/cacheTest.js',['{pro}util/cacheCustom.js','{pro}util/cache.list.custom.js','{lib}util/ajax/xdr.js','{lib}util/cache/cache.js','{lib}util/cache/cookie.js','{lib}util/cache/storage.js','{pro}log.js'],f);
});
