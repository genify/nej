...
var f = function(){
    ...
    // init data
    var _dmap = {
         s:{'北京市':1,'天津市':1,'上海市':1,'重庆市':1,'澳门特别行政区':1},
         p:['北京市','天津市','上海市','重庆市','河北省','山西省','辽宁省','吉林省','黑龙江省','江苏省','浙江省','安徽省','福建省','江西省','山东省','河南省','湖北省','湖南省','广东省','海南省','四川省','贵州省','云南省','陕西省','甘肃省','青海省','西藏自治区','内蒙古自治区','广西壮族自治区','宁夏回族自治区','新疆维吾尔自治区','香港特别行政区','澳门特别行政区'],
         ...
         a:{'河北省-石家庄市':['长安区','桥东区','桥西区','新华区','井陉矿区','裕华区','井陉县','正定县','栾城县','行唐县','灵寿县','高邑县','深泽县','赞皇县','无极县','平山县','元氏县','赵县','辛集市','藁城市','晋州市','新乐市','鹿泉市'],
            ...
            '香港特别行政区-香港岛':['中西区','东区','南区','湾仔区'],
            '香港特别行政区-九龙':['九龙城区','深水埗区','油尖旺区','黄大仙区','观塘区'],
            '香港特别行政区-新界':['离岛区','葵青区','荃湾区','屯门区','元朗区','北区','大埔区','西贡区','沙田区']
         }
     };
};
NEJ.define(
