...
NEJ.define([
    ...
    _pro.__reset = (function(){
        var _cnttpl = '<head><base href="#<BSUL>"/><style>html,body{margin:0;padding:0;border:0;cursor:text;font-size:14px;font-family:Arial;word-wrap:break-word;height:100%;} html{overflow:hidden;}#<UDCS></style></head><body contenteditable="true"></body>';
