...
NEJ.define([
    ...
    _pro.__doBuildGroup = function(_gid){
        ...
        if (!_group){
            _group = _t6._$$SingleGroupManager._$allocate({
                root:this.__root,
                dispatcher:this,
