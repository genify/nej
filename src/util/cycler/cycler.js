...
var f = function(){
     ...
     */
    _p._$$Cycler = NEJ.C();
      _proCycler = _p._$$Cycler._$extend(_p._$$Event);
    /**
     * 控件初始化
     * @protected
     * @method {__init}
     ...
     * @return {Void}
     */
    _proCycler.__reset = function(_options){
        ...
        this.__pager = _p._$$SimplePage._$allocate(this.__popt);
    };
    /**
     * 控件销毁
     * @protected
     ...
     * @return {Void}
     */
    _proCycler.__onPageChange = function(_event){
        this.__timer = window.clearTimeout(this.__timer);
     ...
     * @return {Void}
     */
    _proCycler.__onNextPage = function(){
     ...
     * @return {Void}
     */
    _proCycler.__onImageLoad = function(_isok){
     ...
     * @method {_$setImage}
     * @param  {String} 图片地址
     * @return {nej.ut._$$Cycler}
     */
    _proCycler._$setImage = (function(){
        var _css = {
            opacity:0,
