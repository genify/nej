...
NEJ.define([
    ...
    if (CMPT){
        var _e = NEJ.P('nej.e');
        _e._$addHtmlTemplate     = _p._$add;
        _e._$getHtmlTemplate     = _p._$get;
        _e._$getHtmlTemplateSeed = _p._$seed;
        _e._$renderHtmlTemplate  = _p._$render;
        _e._$registJSTExt        = _p._$extend;
    }
