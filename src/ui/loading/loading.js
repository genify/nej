...
var f = function(){
    ...
    var _seed_css = e._$pushCSSText('\
                     @$<keyframes> #<uispace>-animate{\
                          0%{$<transform>:$<rotate|z=1&a=0deg>;}\
                          8.32%{$<transform>:$<rotate|z=1&a=0deg>;}\
                          8.33%{$<transform>:$<rotate|z=1&a=30deg>;}\
                          16.65%{$<transform>:$<rotate|z=1&a=30deg>;}\
                          16.66%{$<transform>:$<rotate|z=1&a=60deg>;}\
                          24.99%{$<transform>:$<rotate|z=1&a=60deg>;}\
                          25%{$<transform>:$<rotate|z=1&a=90deg>;}\
                          33.32%{$<transform>:$<rotate|z=1&a=90deg>;}\
                          33.33%{$<transform>:$<rotate|z=1&a=120deg>;}\
                          41.65%{$<transform>:$<rotate|z=1&a=120deg>;}\
                          41.66%{$<transform>:$<rotate|z=1&a=150deg>;}\
                          49.99%{$<transform>:$<rotate|z=1&a=150deg>;}\
                          50%{$<transform>:$<rotate|z=1&a=180deg>;}\
                          58.32%{$<transform>:$<rotate|z=1&a=180deg>;}\
                          58.33%{$<transform>:$<rotate|z=1&a=180deg>;}\
                          66.65%{$<transform>:$<rotate|z=1&a=180deg>;}\
                          66.66%{$<transform>:$<rotate|z=1&a=240deg>;}\
                          74.99%{$<transform>:$<rotate|z=1&a=240deg>;}\
                          75%{$<transform>:$<rotate|z=1&a=270deg>;}\
                          83.32%{$<transform>:$<rotate|z=1&a=270deg>;}\
                          83.33%{$<transform>:$<rotate|z=1&a=300deg>;}\
                          91.65%{$<transform>:$<rotate|z=1&a=300deg>;}\
                          91.66%{$<transform>:$<rotate|z=1&a=330deg>;}\
                          100%{$<transform>:$<rotate|z=1&a=330deg>;}\
                     }\
                     ...
                     .#<uispace> > span::before{$<transform>:$<rotate|z=1&a=30deg>;}\
                     .#<uispace> > span::after{$<transform>:$<rotate|z=1&a=-30deg>;}\
                     .#<uispace> > span.z-top{background-color:rgba(170,170,170,0.99);$<transform>:$<rotate|z=1&a=0deg>;}\
                     ...
                     .#<uispace> > span.z-left{background-color:rgba(170,170,170, 0.7);$<transform>:$<rotate|z=1&a=270deg>;}\
                     ...
                     .#<uispace> > span.z-bottom{background-color:rgba(170,170,170,0.4);$<transform>:$<rotate|z=1&a=180deg>;}\
                     ...
                     .#<uispace> > span.z-right{background-color:rgba(170,170,170,0.25);$<transform>:$<rotate|z=1&a=90deg>;}\
