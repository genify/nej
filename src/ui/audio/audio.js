...
var f = function(){
     ...
     * 
     */
    p._$$AudioPlayer = NEJ.C();
    __proAudioPlayer = p._$$AudioPlayer._$extend(p._$$Abstract);
    __supAudioPlayer = p._$$AudioPlayer._$supro;
    /**
     * 初始化外观信息
     * @protected
     * @method {__initXGui}
    ...
    __proAudioPlayer.__initNode = function(){
        this.__supInitNode();
        var _child = e._$getChildren(this.__body);
        this.__nttl = _child[0];
        this.__nact = _child[1];
        v._$addEvent(this.__nact,'tap',
    ...
    __proAudioPlayer.__onAction = function(){
        e._$hasClassName(this.__nact,'js-play')?this._$play():this._$pause();
    };
    /**
     * 返回音频对象
     * @protected
    ...
    __proAudioPlayer.__getAudio = function(_source){
        return t._$$MediaAudio._$allocate({url:_source,
    ...
    __proAudioPlayer.__onStateChange = (function(){
        ...
        return function(_event){
            ...
            e._$replaceClassName(this.__nact,_state_str,
